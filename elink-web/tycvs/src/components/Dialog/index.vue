    ...
    <template v-if="footerVisible" #footer>
      <div class="dialog-footer">
        ...
        <div class="dialog_footer_right">
          ...
          <el-button v-if="confirmVisible" :disabled="listLoading && !disabledLoading" :loading="listLoading && disabledLoading" class="confirmBut" type="primary" @click="clickConfirmBut('confirmBut')">
...
export default defineComponent({
  ...
  emits: ["update:isVisible", "cancel", "confirm"],
  setup(props) {
