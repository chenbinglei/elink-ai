<template>
  <div class="tagsView" v-resize="setMaxNumberFun">
    ...
    <div class="content_right">
      <div class="buttonClass" @click="clickButArrow('arrowLeft')"><span class="iconfont icon-zuodanjiantou"></span></div>
      <div class="buttonClass" @click="clickButArrow('arrowRight')"><span class="iconfont icon-youdanjiantou"></span></div>
                ...
                <template v-for="(item,index) in visitedViews" :key="index">
                  <template v-if="index >= maxNumber"><!--                    && item.name !== 'homePage'-->
                    <div :class="['list_li',item.name === route.name ? 'active_route': '']" @click="clickOpenRoute(item)">
                      ...
                      <div class="list_li_right" @click.stop="clickCloseRoute(item)"><el-icon size="12"><Close/></el-icon></div>
                    </div>
                  </template>
                </template>
              </div>
...
.tagsView {
  ...
  .content_center {
    ...
    .content_route_list{
      ...
      .active_route{
        background-color: rgba(0, 127, 235, .1);
