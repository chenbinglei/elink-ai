  ...
  <div class="standardFeaturesCard">
    <div class="card_left">
      <div class="card_left_top">
        <div class="functionName textTwo">{{ $filters.moreData(cardInfo.reaName) }}</div>
      </div>
      <div class="card_left_bottom">
        <span class="margin_class">{{ $filters.reaType(cardInfo.reaType) }}</span>
<!--        <span class="margin_class">{{ $filters.readWriteType(cardInfo.readWriteType) }}</span>-->
        <span class="margin_class">{{ $filters.required(cardInfo.required) }}</span>
      </div>
    </div>
