<template>
  <div class="inverterDeviceInfo">
    <el-image :src="dianChiIcon" class="card_left_icon"></el-image>
    <div class="card_right_info">
        ...
        <el-col :md="19" :sm="18" :xl="22">
          <div class="flex-ai-center flex-warp left_info">
            ...
            <div class="device_status flex-ai-center">
              ...
              <BatteryDeviceStatusCom :deviceInfo="returnDataInfo"></BatteryDeviceStatusCom>
            </div>
      ...
      <el-row :gutter="12" class="card_right_info_bottom">
        ...
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            <div class="title">额定容量</div>
            <div class="number">
              <span class="numberValue">{{ $filters.numberValue(returnDataInfo.ratedCap) }}</span>
              <span class="unit">{{ $filters.numberUnit(returnDataInfo.ratedCap, 'kWh') }}</span>
            </div>
          </div>
        </el-col>
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            <div class="title">电芯数量</div>
            <div class="number">
              <span class="numberValue">{{ $filters.numberValue(returnDataInfo.cellNum) }}</span>
              <span class="unit">{{ $filters.numberUnit(returnDataInfo.cellNum, '个') }}</span>
            </div>
          </div>
        </el-col>
      </el-row>
...
import dianChiIcon from "@/assets/image/dianChi_icon.png";
import {reactive, defineComponent, toRefs, watch, getCurrentInstance} from "vue";
import {BatteryDeviceStatusCom,DeviceTxStatusCom} from "@/views/centralMonitoring/_components/centralMonitoring/PublicComponents";
...
export default defineComponent({
  ...
  emits: ["changeEvent"],
  components:{BatteryDeviceStatusCom,DeviceTxStatusCom},
  setup(props) {
