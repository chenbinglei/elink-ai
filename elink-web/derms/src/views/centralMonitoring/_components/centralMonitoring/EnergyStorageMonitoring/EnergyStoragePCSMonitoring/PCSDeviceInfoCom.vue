<template>
  <div class="inverterDeviceInfo">
    <el-image :src="pcsIcon" class="card_left_icon"></el-image>
    <div class="card_right_info">
        ...
        <el-col :md="19" :sm="18" :xl="22">
          <div class="flex-ai-center flex-warp left_info">
            ...
            <div class="device_status flex-ai-center">
              ...
              <PCSDeviceStatusCom :deviceInfo="returnDataInfo"></PCSDeviceStatusCom>
            </div>
      ...
      <el-row :gutter="12" class="card_right_info_bottom">
        ...
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            <div class="title">电池簇数量</div>
            <div class="number">
              <span class="numberValue">{{ $filters.numberValue(returnDataInfo.batteryNum) }}</span>
              <span class="unit">{{ $filters.numberUnit(returnDataInfo.batteryNum, '个') }}</span>
            </div>
          </div>
        </el-col>
        <el-col :md="12" :sm="24" :xl="6">
...
import pcsIcon from "@/assets/image/pcs_icon.png";
import {reactive, defineComponent, toRefs, watch, getCurrentInstance} from "vue";
import {PCSDeviceStatusCom,DeviceTxStatusCom} from "@/views/centralMonitoring/_components/centralMonitoring/PublicComponents";

export default defineComponent({
  name: "PCSDeviceInfoCom",
  props: {
    activeDeviceInfo: {
      type: Object,
      default: () => {
  ...
  emits: ["changeEvent"],
  components:{PCSDeviceStatusCom,DeviceTxStatusCom},
  setup(props) {
