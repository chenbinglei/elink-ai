<template>
  <div class="inverterDeviceInfo">
    <el-image :src="dianZhuangIcon" class="card_left_icon"></el-image>
        ...
        <el-col :md="19" :sm="18" :xl="22">
          <div class="flex-ai-center flex-warp left_info">
            ...
            <div class="device_status flex-ai-center">
              ...
              <ElectricPileDeviceStatusCom :deviceInfo="returnDataInfo"></ElectricPileDeviceStatusCom>
            </div>
      ...
      <el-row :gutter="12" class="card_right_info_bottom">
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            ...
            <div class="number">{{ $filters.pileType(returnDataInfo.typeId) }}</div>
          </div>
        </el-col>
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
...
import {DeviceTxStatusCom, ElectricPileDeviceStatusCom} from "@/views/centralMonitoring/_components/centralMonitoring/PublicComponents";

export default defineComponent({
  name: "ElectricPileDeviceInfo",
  props: {
    activeDeviceInfo: {
      type: Object,
      default: () => {
  ...
  emits: ["changeEvent"],
  components:{DeviceTxStatusCom, ElectricPileDeviceStatusCom},
  setup(props) {
