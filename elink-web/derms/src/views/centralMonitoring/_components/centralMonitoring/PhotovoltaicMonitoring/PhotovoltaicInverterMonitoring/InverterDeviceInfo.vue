<template>
  <div class="inverterDeviceInfo">
    <el-image :src="niBianQiIcon" class="card_left_icon"></el-image>
        ...
        <el-col :md="19" :sm="18" :xl="22">
          <div class="flex-ai-center flex-warp left_info">
            ...
            <div class="device_status flex-ai-center">
              ...
              <InverterDeviceStatusCom :deviceInfo="returnDataInfo"></InverterDeviceStatusCom>
            </div>
            <div class="refresh_time">上次更新时间：{{ $filters.moreData(returnDataInfo.runStateTime) }}</div>
          </div>
        </el-col>
      ...
      <el-row :gutter="12" class="card_right_info_bottom">
        ...
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            ...
            <div class="number">
              <span class="numberValue">{{ $filters.numberValue(returnDataInfo.power) }}</span>
              <span class="unit">{{ $filters.numberUnit(returnDataInfo.power, 'kW') }}</span>
            </div>
          </div>
        </el-col>
        <el-col :md="12" :sm="24" :xl="6">
          <div class="card_right_info_bt_li">
            <div class="title">额定电流</div>
            <div class="number">
              <span class="numberValue">{{ $filters.numberValue(returnDataInfo.ratedCurrent) }}</span>
              <span class="unit">{{ $filters.numberUnit(returnDataInfo.ratedCurrent, 'A') }}</span>
            </div>
          </div>
        </el-col>
        <el-col :md="12" :sm="24" :xl="6">
...
import {InverterDeviceStatusCom,DeviceTxStatusCom} from "@/views/centralMonitoring/_components/centralMonitoring/PublicComponents";

export default defineComponent({
  name: "InverterDeviceInfo",
  props: {
    activeDeviceInfo: {
      type: Object,
      default: () => {
  ...
  emits: ["changeEvent"],
  components:{InverterDeviceStatusCom,DeviceTxStatusCom},
  setup(props) {
    ...
    const clickRefreshButFun = ()=>{
      emit("changeEvent",{operateType: "InverterDeviceInfo"});
    };
