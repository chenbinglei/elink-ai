...
export default defineComponent({
  components: {
    CsSettlementManagement, SecondaryDetailsCom, CsChargingRecord, RouteHandleMenus, CsDisChargingRecord, CsPileOccupationRecord
  },
  setup () {
    ...
    const that = reactive({
      routeInfo: {},
      componentName: "CsSettlementManagement",
      routeMenuList: [],
    });
