    ...
    <div class="content_body_right">
      <div class="content_class" v-show="!secondaryDetailsVisible">
        <template v-if="routeMenuList && routeMenuList.length">
          <component ref="componentRef" :is="componentName" :componentName="componentName" :routeInfo="routeInfo" @changEvent="changEvent"></component>
        </template>
...
import {CsPileGunRunningStatus, CsStationManagement, CsChargingRecord, CsDisChargingRecord, CsUserFeedback, CsPileOccupationRecord, CsSettlementManagement,
  CsUserGrouping, CsMiniProgramUsers, CsTransactionDetails, CsInvoiceManage, CsElectricPileLog, CsElectricPileAlarm, CsPileGunManagement, CsBusinessAnalysis,
  CsDataReportManage} from "./ChargingStationOperation/index";

export default defineComponent({
  name: "ChargingStationOperation",
  components: {SecondaryDetailsCom,RouteHandleMenus, CsPileGunRunningStatus, CsStationManagement, CsChargingRecord, CsDisChargingRecord, CsUserFeedback,
