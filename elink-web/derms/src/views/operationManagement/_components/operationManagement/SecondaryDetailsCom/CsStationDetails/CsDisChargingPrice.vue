  ...
  <div class="content_body bg_color_class">
    <div class="content_body_top">
      <buttons-tabs v-model:tabsIndex="componentName" :tabsArray="tabsArray" customClass="connectClass">
        <template #content>
          <el-button v-if="authority === 2" class="whiteFontButtons" type="primary" @click="clickSetPriceBut">
    ...
    <SetPriceDialog v-if="setPriceVisible" v-model:isVisible="setPriceVisible" :chargingType="chargingType" :siteId="siteId" @changeEvent="changeEvent"></SetPriceDialog>
  </div>
</template>
<script lang="ts">
