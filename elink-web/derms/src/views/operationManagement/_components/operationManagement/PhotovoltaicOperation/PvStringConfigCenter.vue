<template>
  ...
  <div class="app-container-right content_border">
    <div class="content_left">
      <HandleMenus :handleMenuArray="handleMenuArray" :treeProps="treeProps" title="组串配置" @handleMenuEvent="handleMenuEvent"></HandleMenus>
    </div>
    <div class="content_right">
      <PvStringConfigTable v-if="activeSiteId" :activeSiteId="activeSiteId"></PvStringConfigTable>
      <null-data v-else words="请联系管理员开放站点权限！"></null-data>
    </div>
  </div>
</template>
...
import PvStringConfigTable from './PvStringConfigCenter/PvStringConfigTable.vue';
