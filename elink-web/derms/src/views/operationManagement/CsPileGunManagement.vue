...
import {
  CsStationManagement, CsChargingRecord, CsDisChargingRecord, CsPileOccupationRecord, CsSettlementManagement,CsPileGunManagement
} from "./_components/operationManagement/ChargingStationOperation"

export default defineComponent({
  components: {
    CsStationManagement, SecondaryDetailsCom, CsChargingRecord,
    CsDisChargingRecord, CsPileOccupationRecord, CsSettlementManagement,CsPileGunManagement
  },
  setup () {
    ...
    const that = reactive({
      routeInfo: {},
      componentName: "CsPileGunManagement",
      routeMenuList: [],
    });
