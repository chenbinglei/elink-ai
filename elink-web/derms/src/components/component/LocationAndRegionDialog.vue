...
import {getLonAndLatByAddress} from "@/api/operationManagement/CsStationDetails";
  ...
  setup(props) {
    ...
    const initL7Map = () => {
      ...
      const map = new mapboxgl.Map({
        ...
        style: "mapbox://styles/sunmax/cl9xyl0im000s14o481h6jaee", //设置地图样式
      });
...
.content_body {
  ...
  .displayFlex {
    ...
    .flex_left, .flex_right {
      ...
      .activeType {
        box-shadow: 0 0 10px 0 #079CEB inset;
      }
