...
public class StationInfoSubscribeVo {
    ...
    public static class PileInfoDto implements Serializable {
         ...
         */
        @Schema(description = "工作状态 0-待机 1-工作 2-维护 3-故障 88-离线")
        private Integer workState;

        /**
         * 充放电接口数量
         */
        @Schema(description = "充放电接口数量")
        private Integer itfNum;

        /**
         * 充放电接口信息
         */
        @Schema(description = "充放电接口信息")
    ...
    public static class ItfInfoDto implements Serializable {
         ...
         * 255 故障；
         */
        @Schema(description = "充放电接口状态 -1-未知 0-空闲 1-充电准备 2-充电中 3-充电完成 4-放电准备 5-放电中 6-放电完成 7-预约 255-故障")
        private Integer workState;
         ...
         */
        @Schema(description = "车辆连接状态 -1-未知 0-未连接 1-半连接 2-已连接")
        private Integer evConnectState;

        /**
         * 是否支持V2G 0-是 1-否
         */
        @Schema(description = "是否支持V2G 0-是 1-否")
