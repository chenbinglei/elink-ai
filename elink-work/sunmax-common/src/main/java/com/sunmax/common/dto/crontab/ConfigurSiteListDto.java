...
@Data
@ApiModel(value = "ConfigurSiteListDto", description = "组态站点列表返回实体类")
public class ConfigurSiteListDto {
     ...
     */
    @ApiModelProperty(value = "能源场景类型 1-光伏 2-储能 3-充电桩 4-用能 5-配电(可存储多个，以逗号分割)")
    private String scenarioTypes;

    /**
     * 站点状态 1-正常 2-预警 3-通信异常 4-故障(多个以逗号分割)
     */
    @ApiModelProperty(value = "站点状态 1-正常 2-预警 3-通信异常 4-故障(多个以逗号分割)")
