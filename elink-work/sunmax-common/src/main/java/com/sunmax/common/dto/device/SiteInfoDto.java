...
@Data
@ApiModel(value = "SiteInfoDto", description = "站点信息返回实体类")
public class SiteInfoDto {
     ...
     * 站点模型id
     */
    @ApiModelProperty(value = "站点模型id")
    private String siteModelId;

    /**
     * 站点读写数据对象
     */
    @ApiModelProperty(value = "站点读写数据对象")
     ...
     * 站点扩展属性对象列表
     */
    @ApiModelProperty(value = "站点扩展属性对象列表")
    private List<DeviceReaDto> siteReaList = Lists.newArrayList();

    /**
     * 站点关联场景类型信息列表
     */
    @ApiModelProperty(value = "站点关联场景类型信息列表")
