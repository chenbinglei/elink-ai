...
public class WebTopicConstant {
    ...
    public static Set<String> getAllTopics(String deviceCode){
        ...
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.DEVICE_COMMAND);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.DEVICE_REQUEST);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.DEVICE_DATA);
        //resultList.add(TopicConstant.TOPIC_PREFIX + terminalCode + TopicConstant.DEVICE_RESPONSE);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.TO_PO_COMMAND);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.TO_PO_RESPONSE);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.SERVICE_DATA);
        //resultList.add(TopicConstant.TOPIC_PREFIX + terminalCode + TopicConstant.SERVICE_COMMAND);
        resultList.add(WebTopicConstant.TOPIC_PREFIX + deviceCode + WebTopicConstant.SERVICE_RESPONSE);
