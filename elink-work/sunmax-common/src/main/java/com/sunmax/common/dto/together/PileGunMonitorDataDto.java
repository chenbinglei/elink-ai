...
@Data
@ApiModel(value = "PileGunMonitorDataDto", description = "电枪监控数据返回实体类")
public class PileGunMonitorDataDto {
     ...
     * 枪原始状态
     */
    @ApiModelProperty(value = "枪原始状态 -1-未知 0-空闲 1-充电准备 2-充电中 3-占用(已连接) 4-放电准备 5-放电中 7-预约 8-暂停 88-离线 255-故障")
