...
public class RedisUtil {
    ...
    public static Object get(String cacheName, String key) {
        return get(String.format("%s::%s", cacheName, key));
    }
    ...
    public static void set(String cacheName, String key, Object value) {
        set(String.format("%s::%s", cacheName, key), value);
    }
    ...
    public static void delete(String cacheName, String key) {
        delete(String.format("%s::%s", cacheName, key));
    }
    ...
    public static void set(String key, Object value, long timeout) {
        redisTemplate.opsForValue().set(key, JSON.toJSON(value), timeout);
    }
