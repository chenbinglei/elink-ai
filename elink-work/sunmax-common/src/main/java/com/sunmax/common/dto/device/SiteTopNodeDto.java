...
@Data
@ApiModel(value = "SiteTopNodeDto", description = "站点拓扑节点返回实体类")
public class SiteTopNodeDto {
    ...
    private List<SiteTopNodeDto.SiteTopItemDto> siteTopItemList = Lists.newArrayList();
