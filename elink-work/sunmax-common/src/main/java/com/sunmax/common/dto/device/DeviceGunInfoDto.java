...
@Data
@Schema(description = "设备电枪信息返回实体类")
public class DeviceGunInfoDto {
     ...
     * 4：直流接口枪头（带枪线，模式 4）
     */
    @Schema(description = "充电枪类型 1-家用插座(模式2) 2-交流接口插座(模式3，连接方式B) 3-交流接口插头(带枪线，模式3，连接方式C) 4-直流接口枪头(带枪线，模式 4)")
