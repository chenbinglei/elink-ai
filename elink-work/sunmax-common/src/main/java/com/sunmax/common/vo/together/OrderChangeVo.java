...
@Data
@ApiModel(value = "OrderChangeVo", description = "订单新增参数实体类")
public class OrderChangeVo {
     ...
     */
    @ApiModelProperty(value = "充放电方式 0-立即充放电 1-定时充放电 2-自动充放电")
     ...
     */
    @ApiModelProperty(value = "策略类型 0-满充/放空 1-定SOC 2-定金额 3-定电量")
     ...
     */
    @ApiModelProperty(value = "支付方式 1-免支付 2-微信支付 3-支付宝支付 4-放电钱包支付")
