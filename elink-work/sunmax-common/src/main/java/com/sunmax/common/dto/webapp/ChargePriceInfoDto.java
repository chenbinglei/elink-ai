...
@Data
@Schema(description = "充放电价格详情实体类")
public class ChargePriceInfoDto {

    /**
     * 当前充放电价格
     */
    @Schema(description = "当前充放电价格")
    private ChargePriceInfoDto.ChargerPrice chargerPrice;

    /**
     * 充放电价格详情列表
     */
    @Schema(description = "充放电价格详情列表")
    ...
    public static class PriceInfoData {
         ...
         * 配置价格信息字符串
         */
        @Schema(description = "配置价格信息字符串")
        private String configPriceInfoStr;

        /**
         * 配置价格信息对象数组
         */
        @Schema(description = "配置价格信息对象数组")
