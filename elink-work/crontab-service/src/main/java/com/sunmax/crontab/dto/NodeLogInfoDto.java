 ...
 */
@Data
@Schema(description = "节点日志信息返回实体类")
public class NodeLogInfoDto {
     ...
     * 日志类型 1-定时任务 2-数据补录
     */
    @Schema(description = "日志类型 1-定时任务 2-数据补录")
    private Integer logType;

    /**
     * 数据点时间
     */
    @Schema(description = "数据点时间")
     ...
     */
    @Schema(description = "日志级别 1-error 2-warning")
     ...
     * 返回值是否是缺省值 1-是
     */
    @Schema(description = "返回值是否是缺省值 1-是")
