 ...
 */
@Configuration
@MapperScan(basePackages = {"com.sunmax.crontab.mapper.mysql","com.sunmax.crontab.dao"}, sqlSessionTemplateRef  = "mysqlSqlSessionTemplate")
public class CrontabMysqlServerConfig {
