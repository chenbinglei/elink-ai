...
@Data
@Schema(description = "站点储能概览曲线数据返回实体类")
public class SiteSeCurveDataDto {
     ...
     * 储能收益
     */
    @Schema(description = "储能收益")
    private BigDecimal income;

    /**
     * 储能循环次数(累计放电量 / 装机容量)
     */
    @Schema(description = "储能循环次数")
     ...
     * 储能购电量(总)
     */
    @Schema(description = "储能购电量(总)")
    public Double supKwh;

    /**
     * 储能购电量(尖时)
     */
    @Schema(description = "储能购电量(尖)")
    public Double topSupKwh;

    /**
     * 储能购电量(峰时)
     */
    @Schema(description = "储能购电量(峰)")
    public Double peakSupKwh;

    /**
     * 储能购电量(平时)
     */
    @Schema(description = "储能购电量(平)")
    public Double plainSupKwh;

    /**
     * 储能购电量(谷时)
     */
    @Schema(description = "储能购电量(谷)")
    public Double valleySupKwh;

    /**
     * 储能购电量(谷时)
     */
    @Schema(description = "储能购电量(深谷)")
    public Double deepSupKwh;

    /**
     * 储能售电量(总)
     */
    @Schema(description = "储能售电量(总)")
    public Double revKwh;

    /**
     * 储能售电量(尖时)
     */
    @Schema(description = "储能售电量(尖)")
    public Double topRevKwh;

    /**
     * 储能售电量(峰时)
     */
    @Schema(description = "储能售电量(峰)")
    public Double peakRevKwh;

    /**
     * 储能售电量(平时)
     */
    @Schema(description = "储能售电量(平)")
    public Double plainRevKwh;

    /**
     * 储能售电量(谷时)
     */
    @Schema(description = "储能售电量(谷)")
    public Double valleyRevKwh;

    /**
     * 储能售电量(谷时)
     */
    @Schema(description = "储能售电量(深谷)")
