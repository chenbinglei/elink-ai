...
//    @GenericGenerator(name = "idGenerator", strategy = "uuid")
     ...
     * 订单号
     */
    @Column(name = "order_num",columnDefinition = "varchar(64) comment '订单号'")
    ...
    @Builder.Default
    private BigDecimal prepayMoney = new BigDecimal("0.0");

    /**
     * 运行模式 0-充电订单 1-放电订单
     */
    @Column(name = "run_mode",columnDefinition = "tinyint(1) comment '运行模式 0-充电订单 1-放电订单'")
    private Integer runMode;

    /**
     * 订单状态 0-未进行 1-充放电中 2-充放电完成 3-启动失败 4-订单挂起 5-订单取消 6-预约中
     */
    @Column(name = "order_status",columnDefinition = "tinyint(1) comment '订单状态 0-未进行 1-充放电中 2-充放电完成 3-启动失败 4-订单挂起 5-订单取消 6-预约中'")
     ...
     * 充电枪编号
     */
    @Column(name = "gun_code",columnDefinition = "int(10) comment '充电枪编号'")
     ...
     * 结束 SOC
     */
    @Column(name = "end_soc", columnDefinition = "int(4) comment '结束 SOC'")
