...
public class ChargeCheckVo {
     ...
     */
    @ApiModelProperty(value = "用车场景 01-私家车 02-运营小客车 03-运营大巴 04-运营货车 05-其它")
    private String scene;

    /**
     * 车辆的类型 01-纯电 02-混动 03-增程
     */
    @ApiModelProperty(value = "车辆的类型 01-纯电 02-混动 03-增程")
    private String vehicleType;

    /**
     * 车辆使用年限 以月为单位。车主填写,有利于提高SOH指标的准确性
     */
    @ApiModelProperty(value = "车辆使用年限")
    private String serviceLife;

    /**
     * 车辆累计里程 以km为单位。车主填写,有利于提高SOH与SOE指标的准确性
     */
    @ApiModelProperty(value = "车辆累计里程")
     ...
     */
    @ApiModelProperty(value = "站点详细地址", required = true)
    private String siteAddress;

    /**
     * 站点经纬度
     */
    @ApiModelProperty(value = "站点经纬度", required = true)
     ...
     */
    @ApiModelProperty(value = "充电前读表值", required = true)
    ...
    public static class DataDto {
         ...
         */
        @ApiModelProperty(value = "直流充电电压", required = true)
        private String dcv;

        /**
         * 直流充电电流 BMS监控桩实时输出电流,单位:A
         */
        @ApiModelProperty(value = "直流充电电流", required = true)
        private String dca;

        /**
         * 充电功率 充电桩充电实时输出的功率,单位:W
         */
        @ApiModelProperty(value = "充电功率", required = true)
