...
public class StationInfoDto {
     ...
     */
    @Schema(description = "充电站所在县以下行政区划代码")
     ...
     * 距离变电站/所最近距离km
     */
    @Schema(description = "距离变电站/所最近距离")
     ...
     * 站点固定资产投资项目代码
     */
    @Schema(description = "站点固定资产投资项目代码")
