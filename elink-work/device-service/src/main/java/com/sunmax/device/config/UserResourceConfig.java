...
import com.sunmax.device.service.feign.SauthService;
...
public class UserResourceConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .antMatchers("/*Websocket/**").permitAll()//WebSocket开放
                .antMatchers("/webServer/**").permitAll()
                .antMatchers("/**").access("isAuthenticated() && @userResourceConfig.canAccess(request, authentication)")//需要认证和权限.antMatchers("/**").permitAll()
