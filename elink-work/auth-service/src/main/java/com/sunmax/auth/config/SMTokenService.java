...
public class SMTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
    @Setter
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        if (existingAccessToken != null && existingAccessToken.getValue() != null) {
            tokenStore.removeAccessToken(existingAccessToken);
        }

        OAuth2AccessToken accessToken = createAccessToken(authentication, null);
