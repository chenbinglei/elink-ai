...
@Data
@ApiModel(value = "SiteIncomeDto", description = "站点收益测算数据返回实体类")
public class SiteIncomeDto {
     ...
     * 收益模型id(目前默认展示工商业V2G)
     */
    @ApiModelProperty(value = "收益模型id(目前默认展示工商业V2G)")
    private String incomeModelId;

    /**
     * 设备总成本(元)
     */
    @ApiModelProperty(value = "设备总成本(元)")
    private BigDecimal deviceCost;

    /**
     * 施工总费用(元)
     */
    @ApiModelProperty(value = "施工总费用(元)")
