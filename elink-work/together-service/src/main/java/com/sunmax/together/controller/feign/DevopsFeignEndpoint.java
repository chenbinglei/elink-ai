...
import com.sunmax.common.feign.devops.DevopsTogetherFeignClient;
...
@Hidden()
public class DevopsFeignEndpoint implements DevopsTogetherFeignClient {
    ...
    @Override
    public ResponseResult<Void> updateInspectSite(@RequestBody AppInspectSiteVo inspectSiteVo) {
