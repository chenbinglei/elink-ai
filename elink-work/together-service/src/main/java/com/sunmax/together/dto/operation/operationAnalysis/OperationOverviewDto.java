...
@Data
@ApiModel(value = "OperationOverviewDto", description = "运营总览返回实体类")
public class OperationOverviewDto {
     ...
     * 充电订单金额比例(%)
     */
    @ApiModelProperty(value = "充电订单金额比例(%)")
     ...
     * 充电实付金额比例(%)
     */
    @ApiModelProperty(value = "充电实付金额比例(%)")
     ...
     * 充电订单数量比例(%)
     */
    @ApiModelProperty(value = "充电订单数量比例(%)")
     ...
     * V2G订单金额比例(%)
     */
    @ApiModelProperty(value = "V2G订单金额比例(%)")
     ...
     * V2G放电电量比例(%)
     */
    @ApiModelProperty(value = "V2G放电电量比例(%)")
     ...
     * 时间利用率比例(%)
     */
    @ApiModelProperty(value = "时间利用率比例(%)")
     ...
     * 度均服务费比例(%)
     */
    @ApiModelProperty(value = "度均服务费比例(%)")
     ...
     * 功率利用率比例(%)
     */
    @ApiModelProperty(value = "功率利用率比例(%)")
     ...
     * 一次充电成功率比例(%)
     */
    @ApiModelProperty(value = "一次充电成功率比例(%)")
