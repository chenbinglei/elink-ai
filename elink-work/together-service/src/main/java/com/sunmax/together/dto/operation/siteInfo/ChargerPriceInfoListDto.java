...
public class ChargerPriceInfoListDto {
    ...
    public static class FixPriceRecord {
         ...
         */
        @Schema(description = "价格状态 1-生效中 2-待生效 3-已失效")
