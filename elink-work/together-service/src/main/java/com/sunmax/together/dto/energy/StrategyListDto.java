 ...
 */
@Data
@ApiModel(value = "StrategyListDto", description = "策略列表返回实体类")
...
public class StrategyListDto {
     ...
     */
    @ApiModelProperty("策略类型 1-综合智能策略 2-峰谷套利策略 3-削峰策略 4-定时策略 5-限电策略 6-变压器扩容 7-负载扩容策略 8-备用电源策略")
    private Integer strategyType;

    /**
     * 执行状态 0-未下发 1-已下发
     */
    @ApiModelProperty("执行状态 0-未下发 1-已下发")
