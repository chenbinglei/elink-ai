...
public class EnergyStorageDto {
     ...
     * 储能类型
     */
    @Schema(description = "储能类型")
    private String storageType;

    /**
     * 储能装机容量-设备总功率
     */
    @Schema(description = "储能装机容量-设备总功率")
    private Double pcsPower;

    /**
     * 储能装机容量-电池簇设备额定容量
     */
    @Schema(description = "储能装机容量-电池簇设备额定容量")
    private Double pcsRatedCap;

    /**
     * 储能实时功率,2位小数
     */
    @Schema(description = "储能实时功率")
     ...
     */
    @Schema(description = "储能并网等级类型 0-0.4kV 1-10kV 2-20kV 3-35kV 4-110kV 5-220kV")
