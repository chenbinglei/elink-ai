...
public class ElectConfigController {
    ...
    @Operation(summary = "新增或编辑电价策略配置数据")
    ...
    @Operation(summary = "批量删除电价策略配置")
    @WebLog("电价配置-批量删除电价策略配置")
    
    @Parameter(name = "ids", description = "多个电价策略配置id 例如[电价策略配置1,电价策略配置2]")
    ...
    @Operation(summary = "根据站点id查询电价策略配置列表")
    ...
    @Operation(summary = "根据电价策略配置id查询电价策略配置数据")
    
    @Parameter(name = "id", description = "电价策略配置id")
    ...
    @Operation(summary = "批量把电价策略应用到其它站点")
    @WebLog("电价配置-批量把电价策略应用到其它站点")
    
    @Parameters({
            @Parameter(name = "electConfigIds", description = "多个电价策略配置id 例如[电价策略配置id1,电价策略配置id2]"),
            @Parameter(name = "siteIds", description = "多个站点id 例如[站点id1,站点id2]")
    })
