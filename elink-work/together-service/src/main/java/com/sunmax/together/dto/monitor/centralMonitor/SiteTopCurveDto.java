...
@Data
@Schema(description = "站点拓扑节点曲线数据返回实体类")
public class SiteTopCurveDto {
     ...
     */
    @Schema(description = "曲线数据对象 (数据类型(0-关口表 1-光伏 2-储能 3-电桩 6-换电 7-负荷) -> 曲线数据列表)")
    ...
    public static class CurveData {
         ...
         */
        @Schema(description = "数据类型 1-关口表 2-光伏 3-储能 4-电桩 5-换电 6-负荷")
        private Integer dataType;

        /**
         * 曲线编号
         */
        @Schema(description = "曲线编号")
