...
@Data
@ApiModel(value = "SeriesConfigChangeVo", description = "组串配置信息保存参数")
public class SeriesConfigChangeVo {
     ...
     * 所属组件id
     */
    @ApiModelProperty(value = "所属组件id")
    private String moduleId;

    /**
     * 组串容量
     */
    @ApiModelProperty(value = "组串容量", required = true)
    private Double seriesCapacity;

    /**
     * 组串名称
     */
    @ApiModelProperty(value = "组串名称", required = true)
