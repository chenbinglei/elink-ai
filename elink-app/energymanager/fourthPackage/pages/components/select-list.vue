<template>
  <view class="alarm-search">
    ...
    <view class="alarm-search-input" :class="{ active: !isHowSelect }">
      <u--input :placeholder="placeholder" border="surround" style="background-color:#F3F3F5;border-radius: 100rpx;" v-model="searchValue" @change="change"
