...
| P1-T3 | JPA ddl-auto 从 update 改为 validate | ✅ 已完成 | 2026-06-03 | 全部10个业务服务 |
| P1-T4 | 清除前端硬编码 IP 地址 | ✅ 已完成 | 2026-06-03 | linkos/derms/tycvs共8个文件替换 |
...
| P1-T9 | 数据库连接 useSSL=false 修复 | ✅ 已完成 | 2026-06-03 | 全部13条JDBC连接 |
