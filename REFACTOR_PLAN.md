...
> 版本：v2.1 | 编制日期：2026-06-03 | 最后更新：2026-06-10 | 状态：**执行中**
>
...
| P2-2c | Spring Boot 2.7→3.3.6 + javax→jakarta + OAuth2迁移 | ✅ 已完成(验证待补全) | 2026-06-09 | pom.xml + 全量javax→jakarta 355处 + OAuth2重写 |
